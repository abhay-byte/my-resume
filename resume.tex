...
\resumeSubHeadingListStart
  \resumeItem{Developed production-ready web and mobile applications for \textbf{2,000+} users over \textbf{2+ years} as a Full-Stack Developer. Contributed to open-source projects, resolved software defects, and rapidly learned new technologies to address business needs.}
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem{Coordinated with \textbf{2} artists/designers to align assets with gameplay.}
    \resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    \resumeItem{Built a data-driven site aggregating \textbf{100+} smartphone SoC profiles and \textbf{2K+} benchmark records for side-by-side comparison.}
    \resumeItem{Optimized PostgreSQL queries to deliver comparison results in under \textbf{300 ms} (\textbf{5×} faster than the initial prototype).}
    \resumeItem{Led code reviews and CI/CD setup with \textbf{3} contributors, maintaining \textbf{90\%} unit-test coverage.}
  \resumeItemListEnd
...
\resumeSubHeadingListStart
  \resumeItem{\textbf{\href{https://leetcode.com/u/abhay-byte/}{LeetCode}:} Solved over \textbf{100} challenges, earned a \textbf{50-day} streak badge, and maintained a \textbf{1409} rating.}
  ...
  \resumeItem{\textbf{\href{https://github.com/abhay-byte/}{GitHub}:} Maintained a \textbf{30-day} streak with over \textbf{650} commits and \textbf{50} merged PRs across \textbf{12} active repositories.}
\resumeSubHeadingListEnd
